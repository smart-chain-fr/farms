...
var farmAddress = process.env.FARM_ADDRESS; //"KT1MRRhLYf3A2eJiZsDkT3FL8GjTeMNSazyQ";
var reward_fa12_contract = process.env.REWARD_CONTRACT_ADDRESS; //"KT1CVLPrSkgzHhSWaaBSvWLGp2fce1iY3wnP";
var rewards = process.env.REWARD_AMOUNT;
function approve() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, Tezos.contract.at(reward_fa12_contract)];
                case 1: return [4 /*yield*/, (_a.sent()).methods.approve(farmAddress, rewards).send()];
                case 2:
                    op2 = _a.sent();
