...
const week_duration = process.env.DURATION_OF_PERIOD;
...
async function orig() {
    ...
    try {
        ...
        // initialize farm (called by admin of the farm) cannot be done by deployer
        console.log("WARNING : admin must initialize the farm")
